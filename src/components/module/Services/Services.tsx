...
const Services = () => {
    ...
    let serviceData = [{
        ...
        describe: "خدمات طب سوزنی شامل لاغری، چاقی، زیبایی، انواع درد ها که شامل کمردرد، سیاتیک و سردرد می باشد، همچنین شامل اختلالات خواب و روانپزشکی می باشد، این اقدامات توسط پزشک انجام می شود"
    },
    {
        id: 1,
        title: "پزشک عمومی",
